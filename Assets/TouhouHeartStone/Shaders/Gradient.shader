	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 normalizeResult61_g7 = normalize( _Direction );
				float dotResult15_g7 = dot( ( uv0_MainTex + float2( 0,0.35 ) ) , normalizeResult61_g7 );
				float4 lerpResult20_g7 = lerp( _Color1 , _Color2 , pow( dotResult15_g7 , _Arg ));
				float4 clampResult63_g7 = clamp( ( lerpResult20_g7 * ( tex2D( _MainTex, uv0_MainTex ) * _Color * IN.color ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				
				half4 color = clampResult63_g7;
...
/*ASEBEGIN
Version=17000
0;268;1093;534;1802.516;404.0515;1.3;True;False
Node;AmplifyShaderEditor.CommentaryNode;10;-1642.673,-331.1708;Float;False;745.126;487.4685;Base;6;21;20;4;6;3;22;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;11;-819.1309,-336.9394;Float;False;489.3;573.2;Gradient;5;9;8;7;19;18;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;20;-1399.516,-86.85147;Float;False;0;0;_Color;Shader;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;21;-1261.717,-50.45145;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;7;-792.674,-283.2483;Float;False;Property;_Color1;Color1;0;0;Create;True;0;0;False;0;1,1,1,1;0,0,0,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-565.5305,140.0429;Float;False;Property;_Arg;Arg;3;0;Create;True;0;0;False;0;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-1036.816,-27.05145;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;18;-584.7999,-158.2001;Float;True;ColorGradient;-1;;7;7164b3169adbd02439a443ddbbc79a71;0;7;3;COLOR;1,1,1,1;False;6;FLOAT2;0,0;False;22;COLOR;1,1,1,1;False;23;COLOR;0,0,0,0;False;58;FLOAT2;0,0.35;False;13;FLOAT2;1,0;False;56;FLOAT;1.25;False;1;COLOR;0
...
ASEEND*/
//CHKSM=44A61542BE8FA83F05284AD0F1A450BFDA12CEAC