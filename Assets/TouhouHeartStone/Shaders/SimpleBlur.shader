...
Shader "THH/SimpleBlur"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				float2 uv0_Texture0 = IN.texcoord.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float x27 = uv0_Texture0.x;
				float offset26 = _Offset;
				float y28 = uv0_Texture0.y;
...
/*ASEBEGIN
Version=17000
252;304;1395;732;6993.682;-1458.708;2.459522;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;151;-5345.083,2186.088;Float;True;Property;_Texture0;Texture 0;2;0;Create;True;0;0;False;0;80ab37a9e4f49c842903bb43bdd7bcd2;80ab37a9e4f49c842903bb43bdd7bcd2;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;4;-4974.012,2055.44;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-4293.507,1993.828;Float;False;Property;_Offset;Offset;0;0;Create;True;0;0;False;0;0.01;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;3;-5385.244,1915.125;Float;True;0;0;_MainTex;Shader;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Matrix3X3Node;93;-4315.402,2103.648;Float;False;Constant;_Matrix;Matrix;2;0;Create;True;0;0;False;0;0.05,0.1,0.05,0.1,0.4,0.1,0.05,0.1,0.05;0;1;FLOAT3x3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;95;-4050.616,2103.024;Float;False;matrix;-1;True;1;0;FLOAT3x3;0,0,0,0,0,1,1,0,1;False;1;FLOAT3x3;0
...
Node;AmplifyShaderEditor.VectorFromMatrixNode;101;-2983.373,2401.107;Float;False;Row;0;1;0;FLOAT3x3;1,0,0,0,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VectorFromMatrixNode;140;-851.0131,2039.607;Float;False;Row;2;1;0;FLOAT3x3;1,0,0,1,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VectorFromMatrixNode;138;-853.883,1641.147;Float;False;Row;2;1;0;FLOAT3x3;1,0,0,0,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VectorFromMatrixNode;104;-1910.002,2008.743;Float;False;Row;1;1;0;FLOAT3x3;1,0,0,1,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VectorFromMatrixNode;103;-1904.567,1625.47;Float;False;Row;1;1;0;FLOAT3x3;1,0,0,0,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VectorFromMatrixNode;99;-2965.068,2022.771;Float;False;Row;0;1;0;FLOAT3x3;1,0,0,0,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VectorFromMatrixNode;96;-2967.938,1624.311;Float;False;Row;0;1;0;FLOAT3x3;1,0,0,0,0,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VectorFromMatrixNode;106;-1920.806,2399.03;Float;False;Row;1;1;0;FLOAT3x3;1,0,0,1,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VectorFromMatrixNode;142;-869.3181,2417.943;Float;False;Row;2;1;0;FLOAT3x3;1,0,0,1,1,1,1,0,1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;149;-4460.047,2288.983;Float;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TexelSizeNode;147;-5030.844,2481.75;Float;False;-1;1;0;SAMPLER2D;;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;148;-4941.906,2310.973;Float;False;Property;_BlurRadius;BlurRadius;1;0;Create;True;0;0;False;0;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;145;-4684.511,2133.739;Float;False;float sigma2 = pow(sigma, 2.0f)@$float left = 1 / (2 * sigma2 * 3.1415926f)@$float right = exp(-(x*x+y*y)/(2*sigma2))@$return left * right@;1;False;3;True;X;FLOAT;0;In;;Float;False;True;Y;FLOAT;0;In;;Float;False;True;Sigma;FLOAT;0;In;;Float;False;GetGaussWeight;True;False;0;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;146;-4693.895,2290.853;Float;False;float sigma = BlurRadius / 3.0@$float4 col = float4(0, 0, 0, 0)@$for (int x = - BlurRadius@ x <= BlurRadius@ ++x)${$    for (int y = - BlurRadius@ y <= BlurRadius@ ++y)$    {$        float4 color = tex2D(_MainTex, UV + float2(x * TexelSize.x, y * TexelSize.y))@$        float weight = GetGaussWeight(x, y, sigma)@$        col += color * weight@$    }$}$return col@;4;False;3;True;UV;FLOAT2;0,0;In;;Float;False;True;BlurRadius;FLOAT;3;In;;Float;False;True;TexelSize;FLOAT4;0,0,0,0;In;;Float;False;GaussBlur;True;False;1;145;3;0;FLOAT2;0,0;False;1;FLOAT;3;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;102.4532,1910.08;Float;False;True;2;Float;ASEMaterialInspector;0;4;THH/SimpleBlur;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;True;2;False;-1;True;True;True;True;True;0;True;-9;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;0;False;-1;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
WireConnection;4;2;151;0
...
WireConnection;146;0;4;0
WireConnection;146;1;148;0
WireConnection;146;2;147;0
WireConnection;0;0;8;0
ASEEND*/
//CHKSM=964FF1762A8454343CF19F79AC3520E41925A804