...
namespace TouhouHeartstone
{
    class UseEvent : VisibleEvent
    {
        ...
        {
            (engine as HeartstoneCardEngine).setGem(player, player.getProp<int>("gem") - card.define.getProp<int>("cost"));
            ...
            {
                //随从卡，将卡置入战场
                (engine as HeartstoneCardEngine).summon(player, card, targetPosition);
