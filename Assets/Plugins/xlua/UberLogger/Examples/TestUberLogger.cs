...
public class TestUberLogger : MonoBehaviour
{
    ...
    public void DoTest()
    {
        ...
        UberDebug.LogTrace("ULogTrace");
        UberDebug.LogTrace("ULogTrace with param {0}", "Test");
        UberDebug.LogTrace(gameObject, "ULogTrace with GameObject");
        UberDebug.LogTrace(gameObject, "ULogTrace with GameObject and param {0}", "Test");

        UberDebug.LogDebug("ULogDebug");
        UberDebug.LogDebug("ULogDebug with param {0}", "Test");
        UberDebug.LogDebug(gameObject, "ULogDebug with GameObject");
        UberDebug.LogDebug(gameObject, "ULogDebug with GameObject and param {0}", "Test");
    }
