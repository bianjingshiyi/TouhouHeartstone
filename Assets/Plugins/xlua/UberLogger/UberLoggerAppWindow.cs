...
public class UberLoggerAppWindow : MonoBehaviour, UberLogger.ILogger
{
    ...
    public void Log(LogInfo logInfo)
    {
        ...
        else if(logInfo.Severity==LogSeverity.Message)
        {
            NoMessages++;
        }
        else if (logInfo.Severity == LogSeverity.Debug)
        {
            NoDebugs++;
        }
        else if (logInfo.Severity == LogSeverity.Trace)
        {
            NoTraces++;
        }
    ...
    void DrawToolbar()
    {
        ...
        var showDebugs = ToggleClamped(ShowMessages, new GUIContent(NoDebugs.ToString(), SmallMessageIcon), toolbarStyle, GUILayout.Height(buttonSize));
        var showTraces = ToggleClamped(ShowMessages, new GUIContent(NoTraces.ToString(), SmallMessageIcon), toolbarStyle, GUILayout.Height(buttonSize));
