...
public static class UberDebug
{
    ...
    [StackTraceIgnore]
    static public void LogDebug(UnityEngine.Object context, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log("", context, LogSeverity.Debug, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogDebug(string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log("", null, LogSeverity.Debug, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogDebugChannel(UnityEngine.Object context, string channel, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log(channel, context, LogSeverity.Debug, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogDebugChannel(string channel, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log(channel, null, LogSeverity.Debug, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogTrace(UnityEngine.Object context, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log("", context, LogSeverity.Trace, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogTrace(string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log("", null, LogSeverity.Trace, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogTraceChannel(UnityEngine.Object context, string channel, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log(channel, context, LogSeverity.Trace, message, par);
#endif
    }

    [StackTraceIgnore]
    static public void LogTraceChannel(string channel, string message, params object[] par)
    {
#if ENABLE_UBERLOGGING
        UberLogger.Logger.Log(channel, null, LogSeverity.Trace, message, par);
#endif
    }
